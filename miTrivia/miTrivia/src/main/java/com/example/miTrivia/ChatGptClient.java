...
public class ChatGptClient {
    public String extractQuestion(String pregunta) {
        ...
        try {
            ...
            connection.setRequestProperty("Authorization", "Bearer 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");//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
